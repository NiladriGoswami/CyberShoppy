...
<html>
<head>
<title>CYBER SHOPPY :: MODULE</title>
			  ...
			  <div class="container-fluid">
			   ...
			   while($row2 = mysqli_fetch_array($result2))
			   {
				...
				?>
					...
					<li class="active menu__item menu"><a class="menu__link" href="contact.php">Contact</a></li>
					<?php if(isset($_SESSION['first_name'])){  ?>
...
<div class="page-head_agile_info_w3l">
		<div class="container">
			<h3>Select<span> Your Module </span></h3>
			<!--/w3_short-->
	    ...
	    <div class="container">
		  <div class="contact-grid-agile-w3s">
				<div class="col-md-4 contact-grid-agile-w3">
						<a href="../inventory_shoppe/admin_login.php"><div class="contact-grid-agile-w31">
							<i class="fa fa-black-tie" aria-hidden="true"></i>
							<h4>Admin</h4>
							<p>Click here if you are Admin,<span> or else select other modules.</span></p>
						</div></a>
			</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<a href="../inventory_shoppe/login.php"><div class="contact-grid-agile-w32">
							<i class="fa fa-group" aria-hidden="true"></i>
							<h4>Vendor</h4>
							<p>Click here if you are Vendor,<span> or else select other modules.</span></p>
						</div></a>
					</div>
					<div class="col-md-4 contact-grid-agile-w3">
						<a href="index.php"><div class="contact-grid-agile-w33">
							<i class="fa fa-user" aria-hidden="true"></i>
							<h4>User</h4>
							<p>Click here if you are User,<span> or else select other modules.</span></p>
						</div></a>
					</div>
					<div class="clearfix"> </div>
		  </div>
...
<div class="contact-w3-agile1 map" data-aos="flip-right"></div>
   <!--//contact-->
   <!--/grids-->
<div class="coupons">
