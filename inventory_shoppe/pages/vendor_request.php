...
<html lang="en">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <td><button type="button" class="btn btn-outline btn-success"><a href="vendor_request.php?I=<?php  echo base64_encode($fres['vendor_id']); ?>">ACCEPT</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="vendor_request.php?D=<?php  echo base64_encode($fres['vendor_id']); ?>">Delete</a></button> </td>
                                                </tr>
