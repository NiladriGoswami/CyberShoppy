...
<html lang="en">
	...
	<form id="form1" name="form1" method="post" action="">
      ...
      <td><button type="button" class="btn btn-outline btn-warning"><a href="user_request.php?I=<?php  echo base64_encode($fres['user_id']); ?>">Accept</a></button> | <button type="button" class="btn btn-outline btn-danger"><a href="user_request.php?D=<?php  echo base64_encode($fres['user_id']); ?>">Block</a></button> </td>
                                                </tr>
